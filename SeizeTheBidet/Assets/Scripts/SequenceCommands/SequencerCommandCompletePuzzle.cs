...
namespace PixelCrushers.DialogueSystem.SequencerCommands
{
    ...
    public class SequencerCommandCompletePuzzle : SequencerCommand
    { // Rename to SequencerCommand<YourCommand>
        ...
        public void Awake()
        {
            ...
            if (TryGetComponent<puzzlePieces>(out puzzlePieces puzzlePiece))
            {
                puzzlePiece = GetComponent<puzzlePieces>();
                puzzlePiece.complete = true;
            }
